...
import { LogoSignUpData, Text } from '../../Static/SignUpPage/SignUpPageData';
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-center justify-center text-center flex-col">
          <h1 className="text-2xl font-bold flex items-center justify-center text-primary sm:text-3xl">
            <img
              src={LogoSignUpData.logoSrc}
              alt={LogoSignUpData.logoAlt}
              width={LogoSignUpData.logoWidth}
              height={LogoSignUpData.logoHeight}
            />
          </h1>
