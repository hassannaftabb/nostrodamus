...
import {
  LogoFeedBackData,
  Text,
} from '../../Static/FeedbackPage/FeedbackPageData';
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-center justify-center text-center flex-col">
          <h1 className="text-2xl font-bold flex items-center justify-center text-primary sm:text-3xl">
            <img
              src={LogoFeedBackData.logoSrc}
              alt={LogoFeedBackData.logoAlt}
              width={LogoFeedBackData.logoWidth}
              height={LogoFeedBackData.logoHeight}
            />
          </h1>
